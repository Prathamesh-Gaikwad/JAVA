...
public class Registration implements ActionListener
{
	...
	Registration()
	{
		...
		choice1.setBounds(1200, 240, 800, 30);
	...
	void myRegistration()
	{
		...
		choice2.setBounds(1100, 190, 400, 30);
			...
			if(event.getSource() == regB)
			{
				...
				if(flag)
				{
					...
					if(choiceStr.toString().equals("Employee"))
						...
						sqlStr.replace(0, sqlStr.length(), "insert into manager (name, password, gmail, reminder) values (?, ?, ?, ?);");
